...
export const AuthContextProvider = ({children}) => {
    ...
    // Register new user with email, password, and name stored in user metadata
...
// Validate access code - checks if code exists, is unused, then marks as used
const validateAccessCode = async (code) => {
    try {
        ...
        // Update user metadata to mark code as validated
